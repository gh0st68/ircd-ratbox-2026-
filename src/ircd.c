 ...
 *  USA
 *
 *  $Id: ircd.c 29213 2015-12-10 13:48:53Z androsyn $
 */
...
{
	unsigned int seed;
	/* rb_get_random() reports success as 1, never -1, so the old ==-1 test
	 * could never fire and a failed draw left seed uninitialised.
	 */
